...
- When the workflow expects a **sharable bundle**: a valid PlatformIO folder (e.g. zip) with scripts may be appropriate — match the user’s request and session norms (Claude Code often edits files in-repo rather than zipping every reply)  
